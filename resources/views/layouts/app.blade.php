        ...
        @if (!isset($menu))
            <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <button class="navbar-toggler float-left mr-3" type="button" data-toggle="collapse"
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto">
                            @auth
                                ...
                                <li class="nav-item @if (in_array(Route::currentRouteName(), ['empresas.index', 'empresas.clientes', 'empresas.produtos', 'empresas.tiposvendas', 'empresas.fabricantes'])) active @endif">
